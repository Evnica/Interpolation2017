...
points4d = time_handler.raise_to_fourth_dimension(points3d=points, time_scale=0.2)
...
for i in range(len(grids)):
    ...
    tree = InverseDistanceWeighting(points4d, values, 10)
    interpolated = tree(6, 1, grids[i])
    ...
    plot = plotly.offline.plot(fig, filename=("idw_p1_n6_st900_ts0.2_" + str(i) + ".html"))
