...
first_coord = round(step / 2, 5)
print(first_coord)
second_coord = step + first_coord
last_coord = round(1 - (step / 2), 5)
print(last_coord)
last_but_one = 1 - step - (step / 2)

indices = []
for i in range(len(grid)):
    # print(grid[i])
    if first_coord in grid[i] or last_coord in grid[i] or second_coord in grid[i] or last_but_one in grid[i]:
